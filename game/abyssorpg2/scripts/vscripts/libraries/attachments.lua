...
--[[
  ...
  -Additionally, ensure that you have the abyssorpg2_attachments.xml, abyssorpg2_attachments.js, and abyssorpg2_attachments.css files in your panorama content folder to use the GUI.
...
function Attachments:start()
  Convars:RegisterCommand( "attachment_configure", Dynamic_Wrap(Attachments, 'ActivateAttachmentSetup'), "Attachment Setup: attachment_configure <ADDON_NAME>  (e.g. attachment_configure abyssorpg2)", FCVAR_CHEAT )
